...
parser.add_argument('--model', '-a', default='ResNet34',
                    )
...
parser.add_argument('--suffix', type=str, default='_baseline1',
                    help='label')
...
if __name__ == '__main__':
    for epoch in range(args.epochs):
        ...
        if test_acc > best_acc:
            best_acc = test_acc
            torch.save(cnn.state_dict(), 'checkpoints_teacher_baseline/' + test_id + '_best.pt')
